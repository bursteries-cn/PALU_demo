...
def _load_single_dataset(dataset_name, dataset_cfg: DictConfig, **kwargs):
    ...
    # 这里做一个特殊处理，因为QAwithLabelDataset需要传入model_name参数
    # Llama-3 的 offset_mapping 有特殊处理
    if "QAwithLabelDataset" not in dataset_handler_name:
...
_register_data(QAwithLabelDataset)
